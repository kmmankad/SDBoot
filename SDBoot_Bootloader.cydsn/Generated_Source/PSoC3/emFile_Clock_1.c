...
{
    if (emFile_Clock_1_CLKEN & emFile_Clock_1_CLKEN_MASK)
    {
...
*
*******************************************************************************/
void emFile_Clock_1_SetModeRegister(uint8 clkMode) 
{
    emFile_Clock_1_MOD_SRC |= clkMode & emFile_Clock_1_MODE_MASK;
}
...
*
*******************************************************************************/
void emFile_Clock_1_ClearModeRegister(uint8 clkMode) 
{
    emFile_Clock_1_MOD_SRC &= ~clkMode | ~emFile_Clock_1_MODE_MASK;
}
...
{
    return emFile_Clock_1_MOD_SRC & emFile_Clock_1_MODE_MASK;
}
...
void emFile_Clock_1_SetSourceRegister(uint8 clkSource) 
{
    ...
    if (oldSrc != CYCLK_SRC_SEL_CLK_SYNC_D && clkSource == CYCLK_SRC_SEL_CLK_SYNC_D && currDiv == 0)
    {
        ...
        emFile_Clock_1_MOD_SRC =
            (emFile_Clock_1_MOD_SRC & ~emFile_Clock_1_SRC_SEL_MSK) | clkSource;
    }
